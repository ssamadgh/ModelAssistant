#
#  Be sure to run `pod spec lint ModelAssistant.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Seyed Samad Gholamzadeh"
  # s.authors            = { "Seyed Samad Gholamzadeh" => "ssamadgh@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Seyed Samad Gholamzadeh"
