...
class GroupOperation: AOperation {
	...
	func addOperations(_ operations: [Foundation.Operation]) {
		for operation in operations {
			internalQueue.addOperation(operation)
		}
	}
...
extension GroupOperation: AOperationQueueDelegate {
    final func operationQueue(_ operationQueue: AOperationQueue, willAddOperation operation: Foundation.Operation) {
